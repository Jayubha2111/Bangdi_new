...
export default function Collection() {
  ...
  return (
    <section id="collection" className="py-20 md:py-28 bg-dark">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {categories.map((cat) => (
            <button
              ...
              className={`filter-tab font-accent text-xs tracking-[0.15em] uppercase px-5 py-2.5 transition-all duration-300 rounded ${
                activeCategory === cat
                  ? 'active text-red-500 bg-dark-surface'
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {filtered.map((product) => (
            <div
              key={product.id}
              className="card-glow bg-dark-card border border-dark-border rounded-lg overflow-hidden group"
            >
              {/* Product image */}
              <div className="relative h-80 md:h-96 w-full bg-gradient-to-br from-red-900/20 via-dark to-black/50 overflow-hidden">
                <Image
              ...
              <div className="p-5 md:p-6">
                ...
                <p className="font-accent text-red-400 text-xs tracking-[0.1em] mb-3 uppercase">
                  {product.subtitle}
                </p>
